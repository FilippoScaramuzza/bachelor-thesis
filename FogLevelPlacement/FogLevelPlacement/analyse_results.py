...
plt.tight_layout()
plt.savefig(pathPlots + 'Sim_result.pdf', format='pdf', dpi=600)
plt.savefig(pathPlots + 'Sim_result.jpg', format='jpg', dpi=600)
plt.savefig(pathResult + 'Sim_result.pdf', format='pdf', dpi=600)
plt.show()
